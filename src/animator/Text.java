...
public class Text {
    ...
    public Text(Game game, GameObject dialogueBox) {
        this.game = game;
    ...
    public void showTextBox(String text) {
        this.dialogueBox.img = getTextImage(text, box, 0, 0);
        //this.dialogueBox.getImage().setTransparency(255); // TODO implement
    }

    public void showText(String text, GameObject actor) {
        actor.img = getTextImage(text, chars[textLookup.indexOf(" ")], 16, 10);
        //actor.getImage().setTransparency(255); // TODO implement
    }

    public BufferedImage getTextImage(String text, BufferedImage baseImg, int xOffset2, int yOffset2) {
        ...
        //img.scale(returnImg.getWidth() * 3, returnImg.getHeight() * 3); // TODO scaling
        return img;
    }
...
class Popup extends Thread {
    ...
    public void run() {
        ...
        UI actor = new UI(new Vector2(0, 0));
        actor.pos = this.pos;
        //this.game.addObject(actor, 100, 100); // TODO implement
        //this.game.render.addParticle(actor); // TODO implement
        //actor.setImage(img); // TODO implement
        try {
            sleep(timeToRun);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
        //this.game.deletionList.add(actor); // TODO implement
        //this.game.render.releaseParticle(actor); // TODO implement
    }

    public void startup(Vector2 pos, Game game, BufferedImage img, int timeToRun) {
        this.pos = pos;
        this.game = game;
        this.img = img;
        this.start();
